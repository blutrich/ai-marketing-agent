...
When generating Base44 presentations, load centralized brand data for accurate content:

**Required reads (for any Base44 content):**
- `Read: /app/brands/base44/brand.json` - Colors, fonts, assets
- `Read: /app/brands/base44/brand-system.md` - Design philosophy
- `Read: /app/brands/base44/tone-of-voice.md` - Voice guidelines

**For content with stats:**
- `Read: /app/brands/base44/facts/metrics.md` - Growth numbers, milestones

**For success story presentations:**
- `Read: /app/brands/base44/case-studies/index.md` - Quick reference
- `Read: /app/brands/base44/case-studies/giftmybook.md` - Full GiftMyBook story

**For credibility slides:**
- `Read: /app/brands/base44/feedback/testimonials.md` - Quotable quotes

**For messaging:**
- `Read: /app/brands/base44/content-library/value-props.md` - Key value propositions
- `Read: /app/brands/base44/content-library/hooks.md` - Attention-grabbing openers
